...
DevAbs:set(Viru.."Abs:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbs:get(Viru.."Abs:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbs:get(Viru.."Abs:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbs:get(Viru.."Abs:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbs:get(Viru.."Abs:Lock:ProNames"..msg.chat_id_) and DevAbs:get(Viru.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbs:get(Viru.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbs:srem(Viru..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbs:get(Viru.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbs:get(Viru.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAbs:sadd(Viru..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAbs:del(Viru.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAbs:set(Viru.."Abs:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAbs:del(Viru.."Abs:Lock:ProNames"..msg.chat_id_)
end
end
